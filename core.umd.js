...
var PolygonManager = (function () {
    ...
    PolygonManager.prototype.createEventObservable = function (eventName, path) {
        return this.createObservableForPolygon(eventName, path, function () { });
    };
    PolygonManager.prototype.createDragEventObservable = function (eventName, path) {
        var _this = this;
        return this.createObservableForPolygon(eventName, path, function (polygon) {
            _this.buildPath(polygon.getPath().getArray(), path.paths);
        });
    };
    PolygonManager.prototype.createObservableForPolygon = function (eventName, path, callback) {
        var _this = this;
        return rxjs_Observable.Observable.create(function (observer) {
    ...
    PolygonManager.prototype.buildPath = function (cordinates, paths) {
        cordinates.forEach(function (cordinate, index) {
            var path = paths[index];
            if (!Array.isArray(cordinate)) {
                this.setCoordinates(path, cordinate);
            }
            else {
                this.buildPath(cordinate, path);
            }
        }, this);
    };
    PolygonManager.prototype.setCoordinates = function (path, coordinate) {
        path.lat = coordinate.lat();
        path.lng = coordinate.lng();
    };
...
var AgmPolygon = (function () {
    ...
    AgmPolygon.prototype._addEventListeners = function () {
        ...
        var os = this._polygonManager.createDragEventObservable('dragend', this)
            .subscribe(function (ev) { return _this.polyDragEnd.emit(ev); });
